package Data::Science::FromScratch::NNLoss;
...
A C<Data::Science::FromScratch::NNLoss> is an abstract class for computing loss in neural networks.
...
L<Data::Science::FromScratch::NNSSE>
